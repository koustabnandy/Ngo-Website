      ...
      exit="exit"
          ...
          >
            <div className="w-24 h-24 rounded-full bg-blue-500 flex items-center justify-center">
              <span className="text-white text-4xl font-bold">NGO</span>
            </div>
          </motion.div>
          ...
          <motion.h2 
            ...
            variants={itemVariants}
          >
            <span className="animate-shimmer-text">Initializing Experience</span>
          </motion.h2>
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            {isClient && [...Array(20)].map((_, i) => (
              <motion.div
                ...
                transition={{ 
                  duration: Math.random() * 4 + 3, // Longer duration for smoother movement
                  repeat: Infinity,
                  ease: [0.43, 0.13, 0.23, 0.96], // Custom easing for smoother animation
                  repeatType: "mirror"
                }}
