    ...
    <footer className="py-16 bg-blue-50">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold text-yellow-300 mb-4">Nirvrti Foundation</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-yellow-300 mb-4">Contact Info</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-yellow-300 mb-4">Follow Us</h3>
            <div className="flex space-x-4">
              <a
                href="https://facebook.com/reachnirvrti"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white p-2 rounded-full text-blue-600 hover:text-blue-700 hover:bg-blue-50 transition-colors"
                aria-label="Facebook"
              >
                <Facebook size={20} />
              </a>
            ...
            <div className="mt-6">
              <h4 className="text-sm font-medium text-blue-700 mb-2">Subscribe to Newsletter</h4>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="px-3 py-2 border border-blue-200 rounded-l-md focus:outline-none focus:ring-1 focus:ring-blue-500 flex-grow"
                />
                <button className="bg-yellow-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r-md transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
