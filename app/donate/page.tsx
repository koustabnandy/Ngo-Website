    ...
    <>
                  ...
                  >
                    {donationCategories.map((cat) => (
                      <div key={cat.value} className="flex items-center space-x-2">
                        ...
                        <Label htmlFor={cat.value} className="text-gray-700 dark:text-gray-200">
                          {cat.label}
                        </Label>
                      </div>
                    ))}
      ...
      <Dialog open={showDonateModal} onOpenChange={setShowDonateModal}>
        <DialogContent className="sm:max-w-md">
          <DialogTitle className="text-xl font-semibold mb-2 text-center text-blue-700 dark:text-blue-400">
